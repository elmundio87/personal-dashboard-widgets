...
module.exports.incidents = function (context) {
    ...
    jira.searchJira('type = "Incident" and statusCategory != "Done"').then(function(result) { 
...
module.exports.mydogdesk = function (context) {
    ...
    jira.searchJira('reporter = currentUser() and project = DOGDESK and type != "Licence"  and (status = "Awaiting Approval" or status = "Waiting for support")').then(function(result) { 
